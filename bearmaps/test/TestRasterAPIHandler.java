...
public class TestRasterAPIHandler {
    ...
    private static final String PARAMS_FILE = "../library-su19/data/proj3_test_inputs/raster_params.txt";
    private static final String RESULTS_FILE = "../library-su19/data/proj3_test_inputs/raster_results.txt";
